...
class NuScenesDataset(Custom3DDataset):
    ...
    def get_data_info(self, index: int) -> Dict[str, Any]:
        ...
        #if data['sample_idx'] == 'ffaea5ef8e964103bc78a263dde4efb4':
        #    print("pause")
        ...
        if self.modality["use_camera"]:
            ...
            for _, camera_info in info["cams"].items():
                data["image_paths"].append('/data/workspace/zhaoyuan/bev/mmdetection3d/' + camera_info["data_path"])
    ...
    def format_results(self, results, jsonfile_prefix='/data/workspace/zhaoyuan/bev/mmdetection3d/work_dirs/test_img_out'):
